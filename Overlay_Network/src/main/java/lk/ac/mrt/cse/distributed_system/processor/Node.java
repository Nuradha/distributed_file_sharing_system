package lk.ac.mrt.cse.distributed_system.processor;
...
public class Node implements Runnable {
    ...
    private ArrayList<Neighbour> neighboursList = new ArrayList<Neighbour>();
    ...
    private void sendJoinRequests() throws IOException {
        ...
        for (Neighbour node : neighboursList) {
    ...
    public void initiateNode() {
        ...
        try {
            ...
            if (nodeCount.equals("0")) {
                ...
                neighboursList.add(new Neighbour(neighbour1[0], Integer.parseInt(neighbour1[1]), neighbour1[2]));
                ...
                String[] neighbour1 = reply.substring(13).split("\\s+");
                neighboursList.add(new Neighbour(neighbour1[0], Integer.parseInt(neighbour1[1]), neighbour1[2]));
                neighboursList.add(new Neighbour(neighbour1[3], Integer.parseInt(neighbour1[4]), neighbour1[5]));
        ...
        try {
            ...
            while (true) {
                ...
                if (command.equals(Config.JOIN)) {
                    ...
                    neighboursList.add(new Neighbour(ip, port, username));
